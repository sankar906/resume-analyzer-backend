-- public.job_description + public.fn_job_description (modes 1–4).
-- Experience is a single free-text column (replaces min_experience / max_experience).

DROP FUNCTION IF EXISTS public.fn_job_description CASCADE;
DROP TABLE IF EXISTS public.job_description CASCADE;
...
CREATE OR REPLACE FUNCTION public.fn_job_description(
    p_mode integer,
    ...
    p_requirements jsonb DEFAULT NULL::jsonb,
    p_responsibilities text DEFAULT NULL::text,
    ...
    p_employment_type character varying DEFAULT NULL::character varying,
    p_remote_allowed boolean DEFAULT NULL::boolean,
    p_hiring_manager character varying DEFAULT NULL::character varying,
    p_openings integer DEFAULT NULL::integer,
    p_dossier_id character varying DEFAULT NULL::character varying,
    p_level character varying DEFAULT NULL::character varying,
    p_reporting_to character varying DEFAULT NULL::character varying
)
RETURNS TABLE(
    id integer,
    jd_id uuid,
...
BEGIN
    ...
    ELSIF p_mode = 2 THEN
        ...
        RETURNING
            ...
            job_description.remote_allowed,
            job_description.hiring_manager,
            job_description.openings,
            job_description.dossier_id,
            job_description.level,
            job_description.reporting_to,
    ...
    ELSIF p_mode = 3 THEN
        ...
        SET
            ...
            experience = COALESCE(p_experience, jd.experience),
